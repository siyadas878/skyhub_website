...
export function IconWhatsApp({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <img src="/whatsapp.svg" alt="WhatsApp" className={`object-contain ${className}`} />
  );
}
...
export function IconTikTok({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.29-2.73.91-5.46 3.08-7.14 1.54-1.19 3.54-1.74 5.48-1.52.01 1.49-.02 2.98-.02 4.47-1.13-.19-2.32.14-3.2.83-.98.77-1.49 1.99-1.37 3.22.12 1.34.98 2.5 2.24 2.97 1.25.47 2.7.2 3.65-.67.74-.68 1.16-1.67 1.15-2.67.02-4.05-.01-8.1.01-12.15z"/>
    </svg>
  );
}
